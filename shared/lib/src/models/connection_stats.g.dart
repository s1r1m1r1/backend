...
ConnectionStatsDto _$ConnectionStatsDtoFromJson(Map<String, dynamic> json) => ConnectionStatsDto(
...
Map<String, dynamic> _$ConnectionStatsDtoToJson(ConnectionStatsDto instance) => <String, dynamic>{
