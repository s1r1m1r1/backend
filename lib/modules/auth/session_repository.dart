...
class SessionRepositoryImpl implements SessionRepository {
  ...
  Future<Session> createSession(User user) async {
    debugLog('$yellow CREATE Session $reset');
    final now = _now();
  ...
  Future<Session> updateSession(Session session) async {
    debugLog('$yellow UPDATE Session $reset');
    final now = _now();
    ...
    final isOk = await sessionDatasource.updateSession(updated);
