...
class CharacterTable extends Table {
  ...
  IntColumn get mind => integer()(); // разум
  IntColumn get resistance => integer()(); // сопротивление

  IntColumn get vitality => integer()(); // жизненная сила
  RealColumn get criticalChance => real()(); // 5%
  RealColumn get criticalDamage => real()(); // 150%
