...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ServerFailure&&(identical(other.message, message) || other.message == message)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&const DeepCollectionEquality().equals(other.errors, errors));
}
...
/// Adds pattern-matching-related methods to [ServerFailure].
extension ServerFailurePatterns on ServerFailure {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ServerFailure value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ServerFailure() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ServerFailure value)  $default,){
final _that = this;
switch (_that) {
case _ServerFailure():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ServerFailure value)?  $default,){
final _that = this;
switch (_that) {
case _ServerFailure() when $default != null:
return $default(_that);case _:
...
class _ServerFailure extends ServerFailure {
  const _ServerFailure({required this.message, this.statusCode = HttpStatus.internalServerError, final  List<String> errors = const []}): _errors = errors,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ServerFailure&&(identical(other.message, message) || other.message == message)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&const DeepCollectionEquality().equals(other._errors, _errors));
}
